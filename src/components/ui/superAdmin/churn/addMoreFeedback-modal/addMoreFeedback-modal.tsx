...
import classes from "./addMoreFeedback-modal.module.css";
...
interface ChurnFeedbackPayload {
  user_id: number;
...
interface BasicModalProps {
  modalValues: { open: boolean; id: number | null };
  handleClose: () => void;
  heading: string;
  subHeading?: string;
  handleAddMoreFeedback?: (data: ChurnFeedbackPayload) => void;
  loading?: boolean;
  success?: any;
}

const AddMoreFeedbackModal: React.FC<BasicModalProps> = memo(
  ({
    modalValues,
    handleClose,
    heading,
    ...
    const handleFormSubmit = useCallback(
      (e?: React.FormEvent) => {
        ...
        const payload: ChurnFeedbackPayload = {
          reason_ids: selectedReasons,
          answers: questionAnswers,
          user_id: user?.id,
          churn_id: modalValues?.id,
        };
...
AddMoreFeedbackModal.displayName = "AddMoreFeedbackModal";

export default AddMoreFeedbackModal;
